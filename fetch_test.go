...
func TestBuildDeepLink(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "EC2 AZ balance links to Instances filtered by AZ",
			checkName:  "Amazon EC2 Availability Zone Balance",
			resourceID: "us-east-1a",
			prettyID:   "us-east-1a",
			metadata:   map[string]any{"Region": "us-east-1"},
			expected:   "https://us-east-1.console.aws.amazon.com/ec2/v2/home?region=us-east-1#Instances:availabilityZone=us-east-1a",
		},
		{
			name:       "Security group unrestricted access links to SG console by name",
			checkName:  "Security Groups - Unrestricted Access",
			resourceID: "sg-0abc123def456",
			prettyID:   "mvmt-us-east-1-prodnv-livekit-sg",
			metadata:   map[string]any{"Region": "us-east-1"},
			expected:   "https://us-east-1.console.aws.amazon.com/ec2/v2/home?region=us-east-1#SecurityGroups:search=mvmt-us-east-1-prodnv-livekit-sg",
		},
		{
			name:       "Inactive VPC interface endpoint",
			checkName:  "Inactive VPC interface endpoints",
			resourceID: "vpce-08168815ab38b5c1c",
			prettyID:   "vpce-08168815ab38b5c1c",
			metadata:   map[string]any{"Region": "eu-west-1"},
			expected:   "https://eu-west-1.console.aws.amazon.com/vpc/home?region=eu-west-1#Endpoints:vpcEndpointId=vpce-08168815ab38b5c1c",
		},
		{
